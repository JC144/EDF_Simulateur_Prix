abonnements.push(
    {
        ...
        prices: [
            { puissance: 3, abonnement: 12.03, bleu: { prixKwhHC: 19.40 } },
            { puissance: 6, abonnement: 15.65, bleu: { prixKwhHC: 19.40 } },
            { puissance: 9, abonnement: 19.56, bleu: { prixKwhHC: 19.27 } },
            { puissance: 12, abonnement: 23.32, bleu: { prixKwhHC: 19.27 } },
            { puissance: 15, abonnement: 26.84, bleu: { prixKwhHC: 19.27 } },
            { puissance: 18, abonnement: 30.49, bleu: { prixKwhHC: 19.27 } },
            { puissance: 24, abonnement: 38.24, bleu: { prixKwhHC: 19.27 } },
            { puissance: 30, abonnement: 45.37, bleu: { prixKwhHC: 19.27 } },
            { puissance: 36, abonnement: 52.54, bleu: { prixKwhHC: 19.27 } }
        ],
        hc: [{
...
abonnements.push(
    {
        ...
        prices: [
            ...
            ...item,
            bleu: { prixKwhHP: 20.65, prixKwhHC: 15.79 }
        })),
        hc: [],
        hasHCCustom: true,
        hasSpecialDaysCustom: false,
